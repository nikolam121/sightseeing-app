...
public class FavouriteServiceImpl implements FavouriteService {
    ...
    public FavouriteServiceImpl(FavouriteMapper favouriteMapper, FavouriteRepository favouriteRepository, LocationRepository locationRepository, UserRepository userRepository, UserMapper userMapper, LocationMapper locationMapper) {
    ...
    public ResponseEntity<FavouriteDto> save(Long userId, String location, String attractionName) {
        ...
        FavouriteDto favouriteDto = new FavouriteDto(locationMapper.toDto(locationRepository.getByName(location)), attractionName, userMapper.toDto(userRepository.getById(userId)));
